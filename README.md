...
<table>
  ...
  <tr>
    <td rowspan=4><b>Проверка значимости линейной корреляционной модели</b></td>
    <td rowspan=2>Значимость коэффициентов выборочного уравнения линейной регрессии</td>
  ...
  <tr>
    <td>Оценка значимости математической модели</td>
    <td>Выборочный коэффициент множественной детерминации</td>
  </tr>
  <tr>
    <td rowspan=1><b>Выбор наилучшей модели</b></td>
    <td></td>
    <td></td>
  </tr>
</table>
